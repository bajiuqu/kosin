package com.bajiuqu.myuser.common.dto;
...
public class UserDTO extends BaseDO {
    ...
    @NotNull(groups = {ValidatedGroup.Insert.class}, message = "注册用户，用户编码不允许为空")
    @NotNull(groups = {ValidatedGroup.Update.class}, message = "更新用户，用户编码不允许为空")
